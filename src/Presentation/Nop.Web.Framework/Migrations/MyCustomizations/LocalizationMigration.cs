...
public class LocalizationMigration : Migration
{
    public override void Up()
    {
        ...
        localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
        {
            ...
            ["Admin.ContentManagement.MessageTemplates.Description.SupportRequest.NewSupportRequest"]
                = "This message template is used when a new support request is created. The message is received by a store owner.",
            ["Admin.ContentManagement.MessageTemplates.Description.SupportRequest.SupportRequestReply"]
                = "This message template is used when a support team replies to a support request. The message is received by a customer who created the support request.",
        });
    }
